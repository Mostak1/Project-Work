...
$conn = db::connect();
$sql = "select o.id,u.first_name u_name,o.total,o.discount,o.comment,o.payment,o.trxid,o.status,o.b_address,o.s_address from `order` o,`users` u where o.user_id=u.id and o.status='Pending' ORDER BY id DESC";
