                ...
                <div class="row">
                    ...
                    <form class="login-form  " action="" method="post">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="text" name="uname" value="<?= $name1 ?? ""?>" required>
                        </div>
                        <div>
                            <label class="form-label mt-3" for="">Email</label>
                            <input class="form-control" type="email" name="email" value="<?= $email1 ?? ""?>">
                        </div>
                       
                        <div>
                            <label class="form-label mt-3" for="">Rank</label>
                            
                            <input class="form-control" type="number" value="<?= $role1 ?? ""?>" name="role">
                        </div>
