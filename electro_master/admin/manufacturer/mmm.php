...
if (isset($_POST['addBtn'])) {
    ...
    if ($conn->affected_rows) {
        header("location:" . settings()['homepage'] . "admin/categories/cdisplay.php");
    } else {
        echo "code error";
    }
}
                ...
                <div class="modal-body">
                    <form class="login-form" action="" method="post">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="text" name="loca" placeholder="address">
                        </div>
                        <div>
                            <label class="form-label" for="">Propiter</label>
                            <input class="form-control" type="text" name="propiter" placeholder="propiter name">
                        </div>
