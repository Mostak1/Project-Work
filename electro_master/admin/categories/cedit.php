...
<?php
$id = $_GET['id'];
$old = "select * from categories where id = '$id'";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `categories` SET `name`='$name',`description`='$des' WHERE id = '$uid'";
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container">
                <div class="row">
                    <h2 class="text-center text-primary">Edit Category From Here</h2>
                    ...
                    <form class="login-form  " action="" method="post">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="text" name="des" value="<?=$oldResult['description']?>" placeholder="Description">
                        </div>
